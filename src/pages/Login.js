...
export default class Login extends React.Component {
  ...
  submit = (e) => {
    e.preventDefault();
    const validate = [validation.isEmail(this.state.login, 'email'),
      validation.pass(this.state.password, 'password')];
    console.log(validate);
    api(this.state, this.props.auth, this.props.currentUser);
